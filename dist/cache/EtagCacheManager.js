...
exports.EtagCacheManager = void 0;
class EtagCacheManager {
     ...
     */
    set(url, etag, data, maxAge, lastModified) {
        // Calcular expiração
        ...
        if (this.options.debug) {
            console.log(`[EtagCache] Cached ${url} with ETag ${etag} (expires in ${ttl}ms)`);
        }
    }
    /**
...
exports.EtagCacheManager = EtagCacheManager;
//# sourceMappingURL=EtagCacheManager.js.map