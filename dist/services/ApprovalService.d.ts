...
import { ApprovalEnvelope, CreateApprovalEnvelopeInput, SendApprovalTokensResponse, ValidateApprovalTokenInput, ValidateApprovalTokenResponse, DecideApprovalInput, DecideApprovalResponse, ApprovalInfo, ApprovalHistoryResponse, SetApprovalModeInput } from '../types/approval.types';
/**
...
export declare class ApprovalService {
     ...
     * ```
     */
    create(dto: CreateApprovalEnvelopeInput): Promise<ApprovalEnvelope>;
    /**
     ...
     * ```
     */
    sendTokens(envelopeId: string): Promise<SendApprovalTokensResponse>;
    /**
     ...
     * ```
     */
    setMode(envelopeId: string, dto: SetApprovalModeInput): Promise<ApprovalEnvelope>;
    /**
     ...
     * ```
     */
    validateToken(dto: ValidateApprovalTokenInput): Promise<ValidateApprovalTokenResponse>;
    /**
     ...
     * ```
     */
    getInfo(envelopeId: string): Promise<ApprovalInfo>;
    /**
     ...
     * ```
     */
    decide(envelopeId: string, dto: DecideApprovalInput, metadata: {
        ip: string;
        userAgent: string;
     ...
     * ```
     */
    getHistory(envelopeId: string): Promise<ApprovalHistoryResponse>;
}
