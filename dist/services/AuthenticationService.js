...
class AuthenticationService {
     ...
     */
    async create(signerId, dto) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/signers/${signerId}/authentication-requirements`, dto);
        return response.data;
    }
    /**
     * Envia token por Email, SMS ou WhatsApp
     */
    async sendToken(authRequirementId) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/authentication-requirements/${authRequirementId}/send-token`);
        return response.data;
    }
    /**
     * Verifica token enviado
     */
    async verifyToken(authRequirementId, dto) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/authentication-requirements/${authRequirementId}/verify-token`, dto);
        return response.data;
    }
    /**
     ...
     * ```
     */
    async uploadDocument(authRequirementId, dto) {
        // Validar arquivo (MIME type e file size)
        (0, validators_1.validateAuthDocumentFile)(dto.file);
        ...
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/authentication-requirements/${authRequirementId}/upload-document`, formData, {
     ...
     * ```
     */
    async getValidationProgress(authRequirementId) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.get(`/api/v1/authentication-requirements/${authRequirementId}/validation-progress`);
        return response.data;
    }
    /**
     ...
     * ```
     */
    async pollValidationProgress(authRequirementId, options = {}, onProgress) {
     ...
     * ```
     */
    async recordIpLocation(authRequirementId, dto) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/authentication-requirements/${authRequirementId}/record-ip-location`, dto);
        return response.data;
    }
    /**
     * Obtém status de autenticação completo do signatário
     */
    async getStatus(signerId) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.get(`/api/v1/signers/${signerId}/authentication-status`);
        return response.data;
    }
    /**
     * Lista requisitos de autenticação de um signatário
     */
    async findBySigner(signerId) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.get(`/api/v1/signers/${signerId}/authentication-requirements`);
        return response.data;
    }
    /**
     * Deleta requisito de autenticação
     */
    async delete(authRequirementId) {
     ...
     */
    async reuseDocument(signerId, method) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/signers/${signerId}/authentication/reuse-document`, { method });
        return response.data;
    }
}
