...
class EnvelopeService {
    ...
    async create(dto) {
        ...
        const response = await this.http.post('/api/v1/envelopes', dto);
    ...
    async findAll(filters) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.get('/api/v1/envelopes', {
            params: filters,
        });
        return response.data;
    }
    ...
    async getAuditTrail(id) {
        const response = await this.http.get(`/api/v1/envelopes/${id}/audit-trail`);
        return response.data;
    }
    /**
    ...
    async update(id, dto) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.put(`/api/v1/envelopes/${id}`, dto);
        return response.data;
    }
    /**
     * Deleta um envelope
    ...
    async activate(id) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/envelopes/${id}/activate`);
        return response.data;
    }
    /**
     * Cancela um envelope
    ...
    async cancel(id, reason) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/envelopes/${id}/cancel`, { reason });
        return response.data;
    }
    /**
    ...
    async notify(id) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/envelopes/${id}/notify`);
        return response.data;
    }
    /**
     ...
     */
    async generateZip(id) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.post(`/api/v1/envelopes/${id}/generate-zip`);
        return response.data;
    }
    /**
     ...
     */
    async getZipStatus(id, jobId) {
        // ✅ v3.0: Direct type (no ApiResponse wrapper)
        const response = await this.http.get(`/api/v1/envelopes/${id}/zip-status/${jobId}`);
        return response.data;
    }
    /**
     ...
     * ```
     */
    async createFromTemplates(input) {
        const response = await this.http.post('/api/v1/envelopes/from-templates', input);
        return response.data;
    }
    /**
    ...
    async getJobStatus(jobId) {
        const response = await this.http.get(`/api/v1/envelopes/jobs/${jobId}`);
        return response.data;
    }
    /**
