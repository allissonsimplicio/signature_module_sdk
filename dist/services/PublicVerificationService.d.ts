 ...
 */
export declare class PublicVerificationService {
    private http;
     ...
     * ```
     */
    verify(hash: string): Promise<VerificationResponse>;
    /**
     ...
     * @throws {ApiError} 403 se verificação pública não habilitada
     */
    verifyByToken(token: string): Promise<VerificationResponse>;
    /**
     ...
     * ```
     */
    download(hash: string): Promise<PublicDownloadResponse>;
    /**
     ...
     * ```
     */
    canDownload(hash: string): Promise<boolean>;
}
//# sourceMappingURL=PublicVerificationService.d.ts.map