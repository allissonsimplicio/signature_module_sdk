...
exports.PublicVerificationService = void 0;
/**
...
class PublicVerificationService {
    ...
    async verify(hash) {
        ...
        const response = await this.http.get(`/api/v1/public/verify/${hash}`);
    ...
    async verifyByToken(token) {
        ...
        const response = await this.http.get(`/api/v1/v/${token}`);
        return response.data;
    }
    /**
    ...
    async download(hash) {
        ...
        const response = await this.http.get(`/api/v1/public/download/${hash}`);
        return response.data;
    }
    // ==================== Helper Methods ====================
    /**
...
exports.PublicVerificationService = PublicVerificationService;
//# sourceMappingURL=PublicVerificationService.js.map